    ...
    return (
      ...
      >
        <ActionButton
          title="Settings"
          width={100}
          fillColor={tab === SETTING_SCREEN ? theme.lightBlue : "lightblue"}
          textColor={
        ...
        <ActionButton
          title="Thoughts"
          width={100}
          fillColor={tab === MAIN_SCREEN ? theme.lightBlue : "lightblue"}
        ...
        <ActionButton
          title="Learn"
          width={100}
          fillColor={tab === EXPLANATION_SCREEN ? theme.lightBlue : "lightblue"}
          textColor={
