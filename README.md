...
The app is not working in curret date. It is showing following errors:
_(a)_ {
"owner": "typescript",
"code": "2418",
"severity": 8,
"message": "Type of computed property's value is 'typeof SettingScreen', which is not assignable to type 'NavigationRouteConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>'.\n Type 'typeof SettingScreen' is not assignable to type 'ComponentClass<any, any> & { navigationOptions?: NavigationScreenConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>; }'.\n Type 'typeof SettingScreen' is not assignable to type '{ navigationOptions?: NavigationScreenConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>; }'.\n Types of property 'navigationOptions' are incompatible.\n Type '{ header: any; }' is not assignable to type 'NavigationScreenConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>'.\n Type '{ header: any; }' is not assignable to type '(navigationOptionsContainer: NavigationScreenConfigProps<NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown> & { ...; }) => NavigationBottomTabOptions'.\n Type '{ header: any; }' provides no match for the signature '(navigationOptionsContainer: NavigationScreenConfigProps<NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown> & { ...; }): NavigationBottomTabOptions'.",

_(b)_ Type of computed property's value is 'typeof PaymentScreen', which is not assignable to type 'NavigationRouteConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>'.
Type 'typeof PaymentScreen' is not assignable to type 'ComponentClass<any, any> & { navigationOptions?: NavigationScreenConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>; }'.
Type 'typeof PaymentScreen' is not assignable to type '{ navigationOptions?: NavigationScreenConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>; }'.
Types of property 'navigationOptions' are incompatible.
Type '{ header: any; }' is not assignable to type 'NavigationScreenConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>'.
Type '{ header: any; }' is not assignable to type '(navigationOptionsContainer: NavigationScreenConfigProps<NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown> & { ...; }) => NavigationBottomTabOptions'.
Type '{ header: any; }' provides no match for the signature '(navigationOptionsContainer: NavigationScreenConfigProps<NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown> & { ...; }): NavigationBottomTabOptions'.

_(c)_ Type of computed property's value is 'typeof default', which is not assignable to type 'NavigationRouteConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>'.
Type 'typeof default' is not assignable to type 'ComponentClass<any, any> & { navigationOptions?: NavigationScreenConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>; }'.
Type 'typeof default' is not assignable to type '{ navigationOptions?: NavigationScreenConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>; }'.
Types of property 'navigationOptions' are incompatible.
Type '{ header: any; }' is not assignable to type 'NavigationScreenConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>'.
Type '{ header: any; }' is not assignable to type '(navigationOptionsContainer: NavigationScreenConfigProps<NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown> & { ...; }) => NavigationBottomTabOptions'.
Type '{ header: any; }' provides no match for the signature '(navigationOptionsContainer: NavigationScreenConfigProps<NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown> & { ...; }): NavigationBottomTabOptions'.

_(d)_ Type of computed property's value is 'typeof SupportScreen', which is not assignable to type 'NavigationRouteConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>'.
Type 'typeof SupportScreen' is not assignable to type 'ComponentClass<any, any> & { navigationOptions?: NavigationScreenConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>; }'.
Type 'typeof SupportScreen' is not assignable to type '{ navigationOptions?: NavigationScreenConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>; }'.
Types of property 'navigationOptions' are incompatible.
Type '{ header: any; }' is not assignable to type 'NavigationScreenConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>'.
Type '{ header: any; }' is not assignable to type '(navigationOptionsContainer: NavigationScreenConfigProps<NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown> & { ...; }) => NavigationBottomTabOptions'.
Type '{ header: any; }' provides no match for the signature '(navigationOptionsContainer: NavigationScreenConfigProps<NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown> & { ...; }): NavigationBottomTabOptions'.

_(e)_ Type of computed property's value is 'typeof MarkdownArticleScreen', which is not assignable to type 'NavigationRouteConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>'.
Type 'typeof MarkdownArticleScreen' is not assignable to type 'ComponentClass<any, any> & { navigationOptions?: NavigationScreenConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>; }'.
Type 'typeof MarkdownArticleScreen' is not assignable to type '{ navigationOptions?: NavigationScreenConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>; }'.
Types of property 'navigationOptions' are incompatible.
Type '{ header: any; }' is not assignable to type 'NavigationScreenConfig<NavigationBottomTabOptions, NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown>'.
Type '{ header: any; }' is not assignable to type '(navigationOptionsContainer: NavigationScreenConfigProps<NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown> & { ...; }) => NavigationBottomTabOptions'.
Type '{ header: any; }' provides no match for the signature '(navigationOptionsContainer: NavigationScreenConfigProps<NavigationTabProp<NavigationRoute<NavigationParams>, any>, unknown> & { ...; }): NavigationBottomTabOptions'.
