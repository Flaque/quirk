...
Unlike many CBT apps, it's fairly unbiased in what you use it for; it doesn't ask you
...
**If you know a language other than English,** help [we translate the app!](/TRANSLATIONS.md)

# Design

Quirk's goal is to be both inviting and focused. It should be __ easy to enter in a thought; people frequently enter these in public settings and need to do it fairly quickly. It also should not cause any increased frustration.
...
**Don't have \ 200 dollars in-app purchases.** I'm looking at your CBT Thought Diary. I get it, developers need to make money. It costs a lot to just keep the app on the app store. But you're preying on vulnerable people. Very few people of rational mind will purposely spend \$200s for a dark mode.
...
Note that this license **does not** give free rein to redistribute the name and branding of quirk. So if you'd like to publish your version, please rename it to avoid end-user confusion.
